    ...
    class Program
    {
        ...
        public static void show_display_devices()
        {
            ...
            while (EnumDisplayDevices(null, devNum, ref lpDisplayDevice, 0))
            {
                ...
                Console.WriteLine("\ndevNum =" + devNum);
                if(devNum < System.Windows.Forms.Screen.AllScreens.Length) 
                    Console.WriteLine("dojhdqsjqds = " + System.Windows.Forms.Screen.AllScreens[devNum].DeviceName);
