...
{
    /// <summary>
    /// Interaction logic for MediaVCEF.xaml
    /// </summary>
    public partial class MediaVCEF : UserControl
    {
                    ...
                    try
                    {
                        if (!coreinit && !e.IsLoading && !cwb.IsLoading)
                        {
                            ...
                            using (StreamReader reader = new StreamReader(stream))
                            {
                                ...
                                CefSharpSettings.ConcurrentTaskExecution = true;
                                cwb.JavascriptObjectRepository.Register("boundobject", new ChromeBoundObject(parent), true, BindingOptions.DefaultBinder);
